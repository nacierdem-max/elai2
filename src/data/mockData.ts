...
export const CHANGE_LOG: ChangeLogEntry[] = [
  ...
  // Year-transition entries (Dec 2025 → Jan 2026)
...
export const PROJECTS: Project[] = [
  { id: 'prj-001', name: 'T9 PLC Ana Kart', leadId: 'p-002', department: ['Elektronik', 'Donanım'], activeTaskCount: 24, completedTaskCount: 9, totalTaskCount: 33, startDate: '03.02.2026', endDate: '30.09.2026', status: 'Aktif', completionPercent: 27 },
  { id: 'prj-002', name: 'Enerji İzleme Sistemi', leadId: 'p-017', department: ['Yazılım', 'Elektronik', 'Test'], activeTaskCount: 36, completedTaskCount: 25, totalTaskCount: 61, startDate: '10.01.2026', endDate: '31.10.2026', status: 'Kritik', completionPercent: 41 },
  { id: 'prj-003', name: 'SCADA 2026', leadId: 'p-017', department: ['Yazılım', 'Otomasyon'], activeTaskCount: 28, completedTaskCount: 13, totalTaskCount: 41, startDate: '12.05.2026', endDate: '30.12.2026', status: 'Aktif', completionPercent: 32 },
  { id: 'prj-004', name: 'Saha Mobile App', leadId: 'p-039', department: ['Yazılım', 'Saha', 'Test'], activeTaskCount: 19, completedTaskCount: 3, totalTaskCount: 22, startDate: '15.03.2026', endDate: '30.06.2026', status: 'Kritik', completionPercent: 14 },
  { id: 'prj-005', name: 'Donanım Test Platformu', leadId: 'p-059', department: ['Donanım', 'Test', 'Elektronik'], activeTaskCount: 15, completedTaskCount: 8, totalTaskCount: 23, startDate: '20.02.2026', endDate: '31.07.2026', status: 'Aktif', completionPercent: 35 },
  { id: 'prj-006', name: 'Termal Yönetim Modülü', leadId: 'p-031', department: ['Mekanik', 'Elektronik'], activeTaskCount: 12, completedTaskCount: 7, totalTaskCount: 19, startDate: '01.03.2026', endDate: '31.08.2026', status: 'Aktif', completionPercent: 37 },
  { id: 'prj-007', name: 'Endüstriyel IoT Gateway', leadId: 'p-049', department: ['Otomasyon', 'Yazılım', 'Donanım'], activeTaskCount: 22, completedTaskCount: 6, totalTaskCount: 28, startDate: '15.04.2026', endDate: '31.12.2026', status: 'Aktif', completionPercent: 21 },
  { id: 'prj-008', name: 'PCB Revizyon 4.0', leadId: 'p-002', department: ['Elektronik', 'Mekanik'], activeTaskCount: 18, completedTaskCount: 12, totalTaskCount: 30, startDate: '04.03.2026', endDate: '30.05.2026', status: 'Kritik', completionPercent: 40 },
  { id: 'prj-009', name: 'Güç Kaynağı Optimizasyonu', leadId: 'p-014', department: ['Elektronik', 'Test'], activeTaskCount: 10, completedTaskCount: 5, totalTaskCount: 15, startDate: '01.04.2026', endDate: '30.06.2026', status: 'Aktif', completionPercent: 33 },
  { id: 'prj-010', name: 'Lojistik Takip Sistemi', leadId: 'p-084', department: ['Yazılım', 'Lojistik'], activeTaskCount: 14, completedTaskCount: 4, totalTaskCount: 18, startDate: '01.05.2026', endDate: '31.10.2026', status: 'Aktif', completionPercent: 22 },
  // Year-spanning project (Dec 2025 → Mar 2026)
  { id: 'prj-011', name: 'Güvenlik Sertifikasyon 2025→2026', leadId: 'p-029', department: ['Yazılım', 'Test'], activeTaskCount: 8, completedTaskCount: 14, totalTaskCount: 22, startDate: '01.11.2025', endDate: '28.02.2026', status: 'Tamamlandı', completionPercent: 100 },
  { id: 'prj-012', name: 'Yıllık Altyapı Yenileme', leadId: 'p-001', department: ['Donanım', 'Yazılım', 'Destek'], activeTaskCount: 5, completedTaskCount: 18, totalTaskCount: 23, startDate: '15.11.2025', endDate: '15.03.2026', status: 'Tamamlandı', completionPercent: 100 },
];

export const TASKS: Task[] = [
  { id: 'tsk-001', name: 'PCB Rev4 Layout', projectId: 'prj-008', assigneeId: 'p-002', status: 'Yapılıyor', startDate: '04.03.2026', endDate: '30.05.2026', remainingDays: 25, subTaskCount: 2, fileCount: 4, messageCount: 7, riskCount: 1, priority: 'Kritik', department: 'Elektronik', description: 'T9 PLC ana kart PCB düzeni revize edilmesi, kat sayısı 6\'dan 8\'e çıkarılıyor.' },
  { id: 'tsk-002', name: 'Termal Simülasyon', projectId: 'prj-002', assigneeId: 'p-039', status: 'Plan', startDate: '20.04.2026', endDate: '15.05.2026', remainingDays: 10, subTaskCount: 1, fileCount: 1, messageCount: 3, riskCount: 1, priority: 'Yüksek', department: 'Test', description: 'Enerji izleme sistemi için ısıl analiz simülasyonları.' },
  { id: 'tsk-003', name: 'Yazılım Refaktörü', projectId: 'prj-003', assigneeId: 'p-017', status: 'Yapılıyor', startDate: '12.05.2026', endDate: '30.06.2026', remainingDays: 56, subTaskCount: 3, fileCount: 2, messageCount: 5, riskCount: 0, priority: 'Yüksek', department: 'Yazılım', description: 'SCADA 2026 modüllerinin TypeScript\'e migrasyon ve refaktörü.' },
  { id: 'tsk-004', name: 'Test Raporu Donanım', projectId: 'prj-005', assigneeId: 'p-040', status: 'Tamamlandı', startDate: '26.03.2026', endDate: '12.04.2026', remainingDays: 0, subTaskCount: 0, fileCount: 3, messageCount: 2, riskCount: 0, priority: 'Orta', department: 'Test', description: 'Donanım test platformu için kapsamlı test raporu oluşturulması.' },
  { id: 'tsk-005', name: 'Mobil App Hata Ayıklama', projectId: 'prj-004', assigneeId: 'p-019', status: 'Gecikmiş', startDate: '28.04.2026', endDate: '10.05.2026', remainingDays: -25, subTaskCount: 1, fileCount: 2, messageCount: 8, riskCount: 2, priority: 'Kritik', department: 'Yazılım', description: 'Saha mobile uygulamasında kritik GPS ve sync hataları giderilmesi.' },
  { id: 'tsk-006', name: 'Firmware Güncelleme v2.4', projectId: 'prj-001', assigneeId: 'p-020', status: 'Test', startDate: '15.04.2026', endDate: '20.05.2026', remainingDays: 15, subTaskCount: 2, fileCount: 3, messageCount: 4, riskCount: 1, priority: 'Yüksek', department: 'Yazılım', description: 'T9 PLC firmware 2.4 sürümü geliştirme ve entegrasyon testleri.' },
  { id: 'tsk-007', name: 'Güç Analiz Raporu', projectId: 'prj-009', assigneeId: 'p-014', status: 'Yapılıyor', startDate: '01.04.2026', endDate: '15.05.2026', remainingDays: 10, subTaskCount: 1, fileCount: 2, messageCount: 3, riskCount: 0, priority: 'Orta', department: 'Elektronik', description: 'Güç kaynağı optimizasyon projesi analiz raporu.' },
  { id: 'tsk-008', name: '3D Mekanik Model Rev2', projectId: 'prj-006', assigneeId: 'p-031', status: 'Yapılıyor', startDate: '01.04.2026', endDate: '31.05.2026', remainingDays: 26, subTaskCount: 2, fileCount: 5, messageCount: 6, riskCount: 0, priority: 'Yüksek', department: 'Mekanik', description: 'Termal yönetim modülü için 3D model revizyonu ve tolerans analizi.' },
  { id: 'tsk-009', name: 'IoT Protokol Entegrasyonu', projectId: 'prj-007', assigneeId: 'p-055', status: 'Plan', startDate: '15.05.2026', endDate: '30.06.2026', remainingDays: 56, subTaskCount: 3, fileCount: 1, messageCount: 2, riskCount: 0, priority: 'Yüksek', department: 'Otomasyon', description: 'Endüstriyel IoT Gateway için MQTT ve Modbus protokol entegrasyonu.' },
  { id: 'tsk-010', name: 'Enerji Sapma Analizi', projectId: 'prj-002', assigneeId: 'p-005', status: 'Riskli', startDate: '01.04.2026', endDate: '01.05.2026', remainingDays: -4, subTaskCount: 1, fileCount: 2, messageCount: 9, riskCount: 3, priority: 'Kritik', department: 'Elektronik', description: 'Enerji izleme sisteminde ölçüm sapma kök neden analizi.' },
  { id: 'tsk-011', name: 'Lojistik Modül Tasarımı', projectId: 'prj-010', assigneeId: 'p-084', status: 'Plan', startDate: '01.05.2026', endDate: '15.06.2026', remainingDays: 41, subTaskCount: 2, fileCount: 1, messageCount: 1, riskCount: 0, priority: 'Orta', department: 'Lojistik', description: 'Lojistik takip sistemi ana modül tasarım ve prototipleme.' },
  { id: 'tsk-012', name: 'PCB Stok Yönetimi', projectId: 'prj-001', assigneeId: 'p-003', status: 'Riskli', startDate: '20.04.2026', endDate: '30.04.2026', remainingDays: -5, subTaskCount: 0, fileCount: 1, messageCount: 4, riskCount: 2, priority: 'Kritik', department: 'Elektronik', description: 'T9 PLC için kritik bileşen stok durumu ve tedarik planlaması.' },
  { id: 'tsk-013', name: 'SCADA Arayüz Tasarımı', projectId: 'prj-003', assigneeId: 'p-018', status: 'Plan Dışı', startDate: '01.05.2026', endDate: '31.05.2026', remainingDays: 26, subTaskCount: 1, fileCount: 2, messageCount: 3, riskCount: 1, priority: 'Yüksek', department: 'Yazılım', description: 'Plan dışı açılan SCADA yeni arayüz tasarım görevi.' },
  { id: 'tsk-014', name: 'Saha Test Protokolü', projectId: 'prj-004', assigneeId: 'p-039', status: 'Yapılıyor', startDate: '15.03.2026', endDate: '30.05.2026', remainingDays: 25, subTaskCount: 2, fileCount: 3, messageCount: 5, riskCount: 1, priority: 'Yüksek', department: 'Test', description: 'Saha mobile uygulaması için saha test protokolü hazırlanması.' },
  { id: 'tsk-015', name: 'Donanım Entegrasyon Testi', projectId: 'prj-005', assigneeId: 'p-059', status: 'Test', startDate: '10.04.2026', endDate: '10.05.2026', remainingDays: 5, subTaskCount: 1, fileCount: 4, messageCount: 6, riskCount: 0, priority: 'Yüksek', department: 'Donanım', description: 'Donanım test platformu entegrasyon testi ve validasyon.' },
  { id: 'tsk-016', name: 'Otomasyon PLC Konfigürasyonu', projectId: 'prj-007', assigneeId: 'p-049', status: 'Yapılıyor', startDate: '20.04.2026', endDate: '20.06.2026', remainingDays: 46, subTaskCount: 2, fileCount: 2, messageCount: 4, riskCount: 0, priority: 'Orta', department: 'Otomasyon', description: 'IoT Gateway için PLC konfigürasyon ve parametre ayarları.' },
  { id: 'tsk-017', name: 'Termal Kaplama Analizi', projectId: 'prj-006', assigneeId: 'p-033', status: 'Plan', startDate: '15.05.2026', endDate: '15.06.2026', remainingDays: 41, subTaskCount: 1, fileCount: 1, messageCount: 2, riskCount: 0, priority: 'Orta', department: 'Mekanik', description: 'Isıl yönetim için yüzey kaplama malzeme analizi.' },
  { id: 'tsk-018', name: 'Güvenlik Protokolü Güncelleme', projectId: 'prj-003', assigneeId: 'p-029', status: 'Gecikmiş', startDate: '01.04.2026', endDate: '25.04.2026', remainingDays: -10, subTaskCount: 1, fileCount: 2, messageCount: 7, riskCount: 2, priority: 'Kritik', department: 'Yazılım', description: 'SCADA güvenlik protokolü ve erişim yönetimi güncelleme.' },
  { id: 'tsk-019', name: 'Batarya Yönetim Sistemi', projectId: 'prj-002', assigneeId: 'p-011', status: 'Plan', startDate: '01.06.2026', endDate: '31.07.2026', remainingDays: 87, subTaskCount: 2, fileCount: 0, messageCount: 1, riskCount: 0, priority: 'Yüksek', department: 'Elektronik', description: 'Enerji izleme için batarya yönetim algoritmaları.' },
  { id: 'tsk-020', name: 'API Entegrasyon Katmanı', projectId: 'prj-010', assigneeId: 'p-020', status: 'Yapılıyor', startDate: '15.05.2026', endDate: '30.06.2026', remainingDays: 56, subTaskCount: 1, fileCount: 2, messageCount: 3, riskCount: 0, priority: 'Orta', department: 'Yazılım', description: 'Lojistik takip sistemi için REST API entegrasyon katmanı.' },
];
...
export const ACTIVITY_LOGS: ActivityLog[] = [
  { id: 'log-001', date: '05.05.2026 14:18', action: 'Görev Güncellendi', userId: 'p-031', projectId: 'prj-008', detail: 'PCB Rev4 Layout — Durum: Plan → Yapılıyor', result: 'Başarılı' },
  { id: 'log-002', date: '05.05.2026 13:45', action: 'Dosya Eklendi', userId: 'p-039', projectId: 'prj-002', detail: 'test_termal_may_v3.pdf yüklendi — Termal Simülasyon görevine', result: 'Başarılı' },
  { id: 'log-003', date: '05.05.2026 12:30', action: 'Risk Açıldı', userId: 'p-017', projectId: 'prj-003', detail: 'Plan Dışı Test Açıklaması riski oluşturuldu', result: 'Açık' },
  { id: 'log-004', date: '05.05.2026 11:15', action: 'Görev Tamamlandı', userId: 'p-040', projectId: 'prj-005', detail: 'Test Raporu Donanım — Tamamlandı olarak işaretlendi', result: 'Tamamlandı' },
  { id: 'log-005', date: '05.05.2026 10:02', action: 'Mesaj Gönderildi', userId: 'p-002', projectId: 'prj-001', detail: 'Ahmet → Burak: "PCB stok durumu kritik, tedarikçi görüşmesi lazım"', result: 'İletildi' },
  { id: 'log-006', date: '04.05.2026 17:30', action: 'Görev Eklendi', userId: 'p-018', projectId: 'prj-003', detail: 'SCADA Arayüz Tasarımı — Plan Dışı görev oluşturuldu', result: 'Plan Dışı' },
  { id: 'log-007', date: '04.05.2026 16:45', action: 'Risk Güncellendi', userId: 'p-005', projectId: 'prj-002', detail: 'Enerji Sapma Riski — Açık durumuna alındı, kalibrasyon ekibi atandı', result: 'Güncellendi' },
  { id: 'log-008', date: '04.05.2026 15:20', action: 'Dosya Eklendi', userId: 'p-019', projectId: 'prj-004', detail: 'hmi_debug_log_v2.zip yüklendi — Mobil App Hata Ayıklama görevine', result: 'Başarılı' },
  { id: 'log-009', date: '04.05.2026 14:00', action: 'Görev Gecikti', userId: 'p-029', projectId: 'prj-003', detail: 'Güvenlik Protokolü Güncelleme — Gecikmiş statüsüne düştü', result: 'Gecikmiş' },
  { id: 'log-010', date: '04.05.2026 11:30', action: 'Görev Güncellendi', userId: 'p-055', projectId: 'prj-007', detail: 'IoT Protokol Entegrasyonu — Öncelik Yüksek\'e çıkarıldı', result: 'Güncellendi' },
];
