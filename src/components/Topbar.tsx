    ...
    >
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <button className="flex items-center gap-2 px-2 py-1.5 rounded-xl transition-all duration-150 hover:bg-gray-100">
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: '#e8f0fb', color: '#0071e3' }}>
            DK
          </div>
          <span className="text-sm font-medium hidden md:block" style={{ color: '#1d1d1f' }}>Derya Koç</span>
